    ...
    <>
      ...
      <section className="flex flex-col-reverse lg:items-center mb-32 lg:flex lg:flex-row lg:mx-32 ">
        ...
        <div className="w-full lg:w-2/4 lg:flex lg:justify-center ">
          <img className="lg:w-3/5" src="https://4.bp.blogspot.com/-UPhMPJP5KVs/WW1AqOntHpI/AAAAAAAA6iA/0oQC8z3fWzIu99gRX_hBFpeg7P3fg_-IgCLcBGAs/s1600/DSC_0018.JPG"></img>
        </div>
      </section>  
      <section className="flex-wrap  lg:items-center mb-32 lg:flex lg:flex-row lg:mx-32 mb-64 ">
      <div className="flex justify-center w-full lg:w-6/12 ">
          <img className="lg:w-5/5" src="https://www.thefrenchjewelrypost.com/content/uploads/2017/08/barbara-langendijk-noon-passama-2.jpg"></img>
        </div>
        <div className="content w-full p-8 lg:py-8 lg:px-24 lg:w-6/12">
